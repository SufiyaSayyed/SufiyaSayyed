...
**Full-Stack Developer | Angular | React | Python | Frontend and GenAI Systems**

I’m a developer with **2+ years of experience** building both production and prototype systems across frontend, backend, and AI stacks — from **Angular-based PWAs** to **Retrieval-Augmented Generation (RAG)** pipelines for enterprise use.  
